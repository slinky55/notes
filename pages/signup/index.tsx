        ...
        <div className={styles.loginContainer}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className={styles.inputContainer}>
                    <label>Email</label>
                    <input type="text" placeholder="email@example.com" {...register("email", { required: true })} autoComplete="off"/>
                ...
                <div className={styles.inputContainer}>
                    ...
                    <input type="password" {...register("confirm", { required: true })} autoComplete="off"/>
                    {errors.confirm ? <span>This field is required</span> : (<span></span>) }
                    { }
                </div>
